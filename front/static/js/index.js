...
window.fetch = async (...args) => {
    ...
    {
        try {
            await fetch('http://10.0.0.101:8888/users/refresh', {
...
function login() {
    ...
    fetch('http://10.0.0.101:8888/users/login', {
        headers: {
...
function registration() {
    ...
    fetch('http://10.0.0.101:8888/users/registration', {
        headers: {
            'content-type': 'application/json',
            'withToken': false
        },
...
async function updateRequestStatus(requestId, requestStatus) {
    try {
        const response = await fetch(`htpp://10.0.0.101:8888/request/${requestId}`, {
            method: `PUT`,
            headers: {
                'content-type': 'application/json',
                'withToken': true
...
async function getAllRequestByUser() {
    try {
        ...
        const response = await fetch(`http://10.0.0.101:8888/requests/get-personal/${userId}`, {
            method: `GET`,
            headers: {
            'content-type': 'application/json',
            'withToken': true      
...
async function getAllRequestForAdmin() {
    try {
        const response = await fetch(`http://10.0.0.101:8888/requests/get-all`, {
            method: `GET`,
            headers: {
            'content-type': 'application/json',
            'withToken': true      
...
async function deleteRequestById(requestId) {
    try {
        const response = await fetch(`http://10.0.0.101:8888/requests/remove/${requestId}`, {
            method: `DELETE`,
            headers: {
            'content-type': 'application/json',
            'withToken': true      
